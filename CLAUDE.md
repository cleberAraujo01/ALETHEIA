...
> **As cinco fatias de engenharia estão feitas (2026-08-17).** A fase NÃO está fechada: o critério de saída é comercial — demo em aplicação de cliente, 3 pilotos, NPS — e o piloto real está bloqueado por configuração da Vercel (§1.4 da medição). O que resta é uso real; código novo agora só entra puxado por piloto.
